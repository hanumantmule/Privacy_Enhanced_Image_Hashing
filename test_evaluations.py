...
def test_image(test_type):
    ...
    print('\n\n ----------------- Testing started --------------- ')
    print('Selected Category:' + test_type)
    ...
    for image in image_list:
        print('Running for Image: ' + str(image))
    ...
    if test_type != 'random':
        plot_graph(x_val_list, y_val_list, test_type + ' Ratio in %', 'Similarity Score',
                   test_type + ' Graph', 'graph_' + test_type + '.png')
    # plot_graph(recall_x_list, recall_y_list, test_type+' Ratio', 'Similarity Score', test_type+' Graph',
    # 'graph_'+test_type+'.png')
